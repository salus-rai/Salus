...
2.	Install Dependencies
        Navigate to the root folder of the project(e.g., D:\salus-rai\responsible-ai-mfe) and run the following command to install all necessary dependencies:
       ```
       npm install
        ```
...
6.	Start the Application
        In the root folder(e.g., D:\salus-rai\responsible-ai-mfe), run the following command to start the application:
        ```
            npm start
        ```
